  ...
  handleCron() {
    ...
    this.motors.forEach((motorId) => {
      ...
      const data = {
        ...
        temperature: this.randomFloat(70, 95), // normal up to 85, anomaly above
        vibration: this.randomFloat(1.0, 4.0), // normal up to 3.0
        current: this.randomFloat(40, 60), 
        voltage: motorId.includes('HV') ? this.randomFloat(11000, 11500) : this.randomFloat(3300, 3500),
      };
